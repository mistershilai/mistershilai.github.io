...
export const places: Place[] = [
  ...
  {
    slug: 'iquitos',
    name: 'Iquitos, Loreto, Peru',
    lat: -3.7437,
    lon: -73.2516,
    blurb: 'Largest city on Earth unreachable by roads and gateway to the Amazon.',
    video: {
      file: 'Loreto_AmazonRiver.mp4',
      description: 'The Amazon discharges more water than the next seven largest rivers combined, and even at Loreto, more than two thousand miles upstream, it stays deep enough for ocean-going ships to reach the docks at Iquitos.',
    },
    photos: [
      { file: 'IMG_8548.jpeg' },
      { file: 'IMG_8556.jpeg' },
  ...
  {
    slug: 'ica-huacachina',
    name: 'Ica and Huacachina, ICA, Peru',
    lat: -14.0700,
    lon: -75.7300,
  ...
  {
    slug: 'cusco',
    name: 'Cusco and the Inca Trail, CUS, Peru',
    lat: -13.3500,
    lon: -72.2500,
  ...
  {
    slug: 'joyadecerensanandres',
    name: 'Joya de Cerén / San Andrés National Archeological Park, El Salvador',
    lat: 13.8275,
    lon: -89.3578,
    blurb: 'The Pompeii of the Americas.',
    photos: [
      { file: 'IMG_1075.jpeg' },
      { file: 'IMG_1092.jpeg' },
      { file: 'IMG_7191.jpeg' },
