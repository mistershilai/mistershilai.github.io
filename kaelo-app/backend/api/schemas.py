...
class OptimizationRequest(BaseModel):
    ...
    scenario: str = Field("2526", description="Demand scenario: 2526 | 2627")
    ...
    shortage_penalty: float = Field(5.0, ge=0, description="Shortage penalty as multiplier of the unit cost you supply")
